...
# Version 1.0.1 downloaded from mendeley.com is NOT version 1.0.1 but version
# 1.0!
...
SRC_URI="https://s3.amazonaws.com/mendeley-desktop-download/linux/${P}-${LNXARCH}.tar.bz2"
